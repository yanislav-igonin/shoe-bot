export const replies = {
  ...
  errorEditingImage:
    'Произошла ошибка при редактировании изображения. Пожалуйста, попробуйте еще раз.',
  help:
  ...
  replyToImageToEdit:
    'Пожалуйста, ответьте на изображение, которое вы хотите отредактировать, с вашим текстовым запросом.',
  start:
    'Привет, я Ботинок.' +
